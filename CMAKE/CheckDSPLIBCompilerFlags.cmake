...
macro( CheckDSPLIBCompilerFlags )
...
if( FPE_EXIT )
  message( FATAL_ERROR "Floating Point Exception (FPE) trap handlers are currently explicitly enabled in the compiler flags.  DSPLIB is designed to check for and handle these cases internally and enabling these traps will likely cause DSPLIB to crash.  Please re-configure with floating point exception trapping disabled." )
endif()
